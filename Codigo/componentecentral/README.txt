...
a persistence unit "componentecentralPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "componentecentral\pom.xml":
...
artifacts ("componentecentral-ejb.jar" and "componentecentral-web.war") are already built. You can build
