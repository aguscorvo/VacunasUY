...
a persistence unit "nodosperifericosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "nodosperifericos\pom.xml":
...
artifacts ("nodosperifericos-ejb.jar" and "nodosperifericos-web.war") are already built. You can build
